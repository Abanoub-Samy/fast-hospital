...
import com.example.mapsactivty.internet.Fire;
...
public class NearestHospitalActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.room) {
            Intent myIntent = new Intent(getBaseContext(),   Room.class);
            startActivity(myIntent);
        } else if (id == R.id.medicine) {
            Intent myIntent = new Intent(getBaseContext(),   Medicine.class);
            startActivity(myIntent);
        } else if (id == R.id.Blood) {
            Intent myIntent = new Intent(getBaseContext(),   BloodActivity.class);
            startActivity(myIntent);
